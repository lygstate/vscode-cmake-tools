...
import { EnvironmentVariablesNull, EnvironmentVariablesUndefined, EnvironmentVariablesUtils } from './environmentVariables';
   ...
   */
    ...
    async launchTarget(name?: string) {
        ...
        const termOptions: vscode.TerminalOptions = {
            name: 'CMake/Launch',
            env: launchEnv as EnvironmentVariablesNull,
